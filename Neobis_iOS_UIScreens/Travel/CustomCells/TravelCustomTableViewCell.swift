//
//  TravelCustomTableViewCell.swift
...
class TravelCustomTableViewCell: UITableViewCell {
    ...
    func setupConstraints() {
        ...
        [titleLabel, lineImage, cityImage, darkness].forEach{$0.translatesAutoresizingMaskIntoConstraints = false}
